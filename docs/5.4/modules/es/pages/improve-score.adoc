...
[#_improving_the_security_risk_score]
...
[#_how_to_improve_the_score]
=== Cómo mejorar la puntuación

[#_product_protection_mode]
...
[#_privileged_and_or_root_containers]
...
[#_how_to_customize_which_container_groups_are_included_in_the_score]
